...
const double SIZE_FACTOR = 5;

const double ENEMY_MASS = 50;
const double ENEMY_SPEED = 40;
const double ENEMY_RELOAD_SPEED = 20;
const size_t ENEMY_COUNT_PYRAMID_TOP = 15;    // 13 - 15
const size_t ENEMY_COUNT_PYRAMID_BOTTOM = 10; // 8 - 10
...
const vector_t BLOCKADE_DIMENSIONS = {SIZE_FACTOR * 4 * PLAYER_BODY_RADIUS,
                                      SIZE_FACTOR * 2};   // width = double player width
