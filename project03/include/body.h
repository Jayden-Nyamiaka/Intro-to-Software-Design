 ...
 *
 * @param body a pointer to a body returned from body_init()
 * @return the body's current rotation in radians
 */
 ...
 */
double body_get_angular_vel(body_t *body);
...
/**
 * @brief sets the display color of a body
 *
 * @param color a pointer to a body returned from body_init()
 * @return rgb_color_t the new color of the body as an (R, G, B) tuple
 */
...
/**
 * Changes the rotation velocity of the body (time-derivative of it's rotation)
 *
 * @param body a pointer to a body returned from body_init()
 * @param velocity the body's new rotational velocity
 */
