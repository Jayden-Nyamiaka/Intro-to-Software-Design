 ...
 *
 * @param body a pointer to a body returned from body_init()
 * @return a copy of body's shape describing the body's current position
 */
list_t *body_get_shape(body_t *body);

/**
 * Gets the real current shape of a body.
 * This is not a copy, but a pointer to the body's actual polygon.
 *
 * @param body a pointer to a body returned from body_init()
 * @return the body's real shape describing the body's current position
 */
...
/**
 * Gets the rotation of a body in radians.
 *
 * @param body a pointer to a body returned from body_init()
...
/**
 * Gets the current angular velocity of a body in radians.
 *
 * @param body a pointer to a body returned from body_init()
 * @return the body's angular velocity in radians
 */
 ...
 *
 * @param body a pointer to a body returned from body_init()
 * @param velocity the body's new angluar velocity in radians.
...
/**
 * Dilates the x-component of the body
 * Note: preserves centroid
 *
 * @param body a pointer to a body returned from body_init()
...
/**
 * Dilates the y-component of the body
 * Note: preserves centroid
 *
 * @param body a pointer to a body returned from body_init()
 * @param factor the dilation factor
...
/**
 * Sets force and impulse of body to VEC_ZERO,
 * erasing any force and impulse added so far.
 *
 * @param body a pointer to a body returned from body_init()
 */
void body_reset_force_and_impulse(body_t *body);
...
/**
 * Gets if the body can be removed.
 *
 * @param body the body where removability is set
 * @param removable the body's new removability
 */
bool body_is_removable(body_t *body);

/**
 * Sets if the body can be removed.
 *
 * @param body the body where removability is set
 * @param removable the body's new removability
 */
